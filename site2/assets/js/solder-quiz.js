...
const quizQuestions = [
  ...
  {
    question: "Какая температура на дисплее станции считается оптимальной для ручной пайки стандартным припоем ПОС-61 (солидус 183 °C / ликвидус 190 °C по ГОСТ 21930-76)?",
    options: [
      "195°C — 205°C (впритык к точке ликвидуса)",
      "270°C — 310°C (с учётом теплоотвода платы и градиента «нагреватель–жало»)",
      "390°C — 430°C",
      "500°C"
    ],
    correct: 1,
    explanation: "Ликвидус ПОС-61 составляет 190 °C (не путать с зарубежной эвтектикой Sn63Pb37 с точкой 183 °C). Чтобы температура в месте пайки достигла 220–240 °C с учётом теплоотвода текстолита, уставка станции обычно выбирается в диапазоне 270–310 °C. Работа выше 350 °C мгновенно сжигает флюс и окисляет покрытие жала."
  },
  {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function showResults() {
    ...
    let label = '';
    if (score === 10) label = 'Квалификация: Эксперт-технолог. Вы знаете температуру и свойства припоев с закрытыми глазами.';
    else if (score >= 7) label = 'Квалификация: Инженер-практик. Отличный уровень понимания физики процессов.';
    else if (score >= 5) label = 'Квалификация: Радиомонтажник. Хорошая база, рекомендуем повторить режимы термопрофилей.';
    else label = 'Рекомендуем изучить основы термопрофилей и свойства флюсов в нашем справочнике.';
