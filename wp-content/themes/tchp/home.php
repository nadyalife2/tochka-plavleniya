<?php
/**
 * The template for displaying the blog posts feed
 *
 * @package TCHP
 * @version 2.0.0
 */
...
<main class="w-full flex-grow pt-8 pb-16">
  <div class="max-w-[1140px] mx-auto px-5 sm:px-8 space-y-8">
    ...
    <header class="border-b border-paper-border pb-6 space-y-2">
      <h1 class="text-3xl sm:text-4xl font-bold tracking-tight text-ink">Лента статей и регламентов</h1>
      <p class="text-sm font-mono text-ink-muted">Все публикации открытой лаборатории ТЧП</p>
    </header>
    ...
    <?php else : ?>
      <p class="text-ink-muted py-8 font-mono text-center">Записей пока нет.</p>
    <?php endif; ?>
